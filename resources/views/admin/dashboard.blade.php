...
<head>
    ...
    <link rel="stylesheet" href={{URL::asset('dist/assets/css/main/app-dark.css')}}>
...
<body>
    ...
    <div class="sidebar-header position-relative">
        <div class="d-flex justify-content-between align-items-center">
            <div class="logo">
                <a href="{{url('/')}}"><img src={{URL::asset('dist/assets/images/logo/logo.svg')}} alt="Logo" srcset=""></a>
            </div>
