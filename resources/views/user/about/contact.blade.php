                                        ...
                                        <div id="carouselExampleSlidesOnly" class="carousel slide"
                                            ...
                                            <div class="carousel-inner">
                                                <div class="carousel-item active">
                                                    <img src={{ URL::asset('dist/assets/images/samples/building.jpg') }}
                                                        class="d-block w-100" alt="...">
                                                </div>
                                                <div class="carousel-item">
                                                    <img src={{ URL::asset('dist/assets/images/samples/architecture1.jpg') }}
                                                        class="d-block w-100" alt="...">
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <form action="#">
                                            ...
                                            <button class="btn btn-primary btn-block btn-lg shadow-lg mt-5">Send
                                                Message</button>
                                        </form>
                                    </div>
                                    <div class="card-body">
